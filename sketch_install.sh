...
####################################################
#  
#  this script installs the latest versio of
#+ Sketch. If installed version is not current
#+ it will remove and install latest and greatest
#
####################################################
#  variables
#  The license key can be entered into the #4 field
#+ in the JSS
####################################################
